...
import pql from "../assets/skills/pql.png";
...
const Skills = () => {
  ...
  return (
    <div>
      <h2 className="text-center text-[#FF014F] pb-10 lg:text-5xl md:text-4xl text-3xl lg:mt-0 mt-16  font-bold">
        My Skills
      </h2>
      <div id="skills" className="bg-rose-600/10 backdrop-blur">
        <section className="px-4 py-7 lg:px-0 max-w-7xl mx-auto overflow-hidden">
          ...
          >
            ...
            <SwiperSlide className=" rounded-lg">
              <div className="flex flex-col justify-center my-10 items-center">
                <img className="h-18" src={redux} alt="" />
                <p className="text-xl mt-3 text-white font-bold">Redux</p>
              </div>
            </SwiperSlide>
            <SwiperSlide className=" rounded-lg">
              <div className="flex flex-col justify-center my-10 items-center">
            ...
            <SwiperSlide className=" rounded-lg">
              <div className="flex flex-col justify-center my-10 items-center">
                <img className="h-18" src={pql} alt="" />
                <p className="text-xl mt-3 text-white font-bold">PostgreSQL</p>
              </div>
            </SwiperSlide>
            <SwiperSlide className=" rounded-lg">
              <div className="flex flex-col justify-center my-10 items-center">
